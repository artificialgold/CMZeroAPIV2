...
#line 6
 testRunner.Then("I should be able to get the application with a new apikey", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Then ");
#line hidden
...
#line hidden
        ...
        [NUnit.Framework.TestAttribute()]
        [NUnit.Framework.DescriptionAttribute("Creating an application with an application name that already exists for this org" +
            "anisation")]
        [NUnit.Framework.CategoryAttribute("Application")]
        public virtual void CreatingAnApplicationWithAnApplicationNameThatAlreadyExistsForThisOrganisation()
        {
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("Creating an application with an application name that already exists for this org" +
                    "anisation", new string[] {
                        "Application"});
#line 19
this.ScenarioSetup(scenarioInfo);
#line 20
 testRunner.Given("I create an application with a name already existing for an organisation", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Given ");
#line 21
 testRunner.Then("I should get a ApplicationNameAlreadyExistsException", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Then ");
#line hidden
            this.ScenarioCleanup();
        }
    }
